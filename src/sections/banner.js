      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            ...
            <Text as="p">
              The field of space exploration is getting crescendo, a curious industry which is concealed and its potential increases above infinity.
              Many companies and entrepreneurs are running wild behind space exploration and technology, believing in the fact that planets and stars are inference.
              Being the youth, we are here to write our antedotes in the field of space exploration and finding our solace in the cosmos.
            </Text>
          </Box>
          <Box sx={styles.image}>
