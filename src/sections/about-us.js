...
const TESTIMONIALS_DATA = [
  {
    ...
    heading: 'About Us',
    content:
      "Argon Space labs is an organisation run by students. Where students around the world work in the fields of aerospace, astronomy, astrophysics, astrobiology, aeronautics, aviation and also find new technology solutions for future space missions.",
  },
];
